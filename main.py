...
photologo = 'https://te.legra.ph/file/bab32dc89d901c76b26da-2a3ca75dca4b3fdba0.jpg' #https://envs.sh/GV0.jpg
photoyt = 'https://te.legra.ph/file/bab32dc89d901c76b26da-2a3ca75dca4b3fdba0.jpg' #https://envs.sh/GVi.jpg
photocp = 'https://te.legra.ph/file/bab32dc89d901c76b26da-2a3ca75dca4b3fdba0.jpg'
photozip = 'https://te.legra.ph/file/bab32dc89d901c76b26da-2a3ca75dca4b3fdba0.jpg'


# Inline keyboard for start command
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/MadXContactBot")]])
keyboard = InlineKeyboardMarkup(
    [
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/MadXContactBot"), InlineKeyboardButton(text="🛠️ Repo", url="https://github.com")],
    ]
)

# Image URLs for the random image feature
image_urls = [
    "https://te.legra.ph/file/bab32dc89d901c76b26da-2a3ca75dca4b3fdba0.jpg",
    "https://te.legra.ph/file/bab32dc89d901c76b26da-2a3ca75dca4b3fdba0.jpg",
...
async def start(bot, m: Message):
    ...
    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://te.legra.ph/file/bab32dc89d901c76b26da-2a3ca75dca4b3fdba0.jpg",
        caption=caption
    )
    ...
    if m.chat.id in AUTH_USERS:
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton(text="📞 Contact", url=f"tg://openmessage?user_id={BOT}"), InlineKeyboardButton(text="🛠️ Repo", url="https://github.com")],
        ])
        ...
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [{CREDIT}⁬](tg://openmessage?user_id={BOT})\n", disable_web_page_preview=True, reply_markup=keyboard
        )
    else:
...
async def back_to_main_menu(client, callback_query):
    ...
    await callback_query.message.edit_media(
      InputMediaPhoto(
        media="https://te.legra.ph/file/bab32dc89d901c76b26da-2a3ca75dca4b3fdba0.jpg",
        caption=caption
      ),
...
async def upgrade_button(client, callback_query):
  ...
  caption = (
           ...
           f"<b>💵 Per Day Plan: 50 INR</b>\n\n"
           f"If you want to buy membership of the bot, feel free to contact [{CREDIT}](tg://user?id={BOT})\n"
    )  
...
async def id_command(client, message: Message):
    keyboard = InlineKeyboardMarkup([[InlineKeyboardButton(text="Send to Owner", url=f"tg://openmessage?user_id={BOT}")]])
